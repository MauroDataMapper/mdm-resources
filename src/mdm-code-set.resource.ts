...
export class MdmCodeSetResource extends MdmResource {
    ...
    finalise(codeSetId: string, data?, restHandlerOptions?: RequestSettings) {
    ...
    addCodeSetsToFolder(folderId: string, data: any, restHandlerOptions?: RequestSettings) {
    ...
    remove(codeSetId: string, queryStringParams?: QueryParameters, restHandlerOptions?: RequestSettings) {
        const url = `${this.apiEndpoint}/codeSets/${codeSetId}`;
        return this.simpleDelete(url, queryStringParams, restHandlerOptions);
    }

    update(codeSetId: string, data: any, restHandlerOptions?: RequestSettings) {
        const url = `${this.apiEndpoint}/codeSets/${codeSetId}`;
        return this.simplePut(url, data, restHandlerOptions);
    }
    ...
    get(codeSetId: string, queryStringParams?: QueryParameters, restHandlerOptions?: RequestSettings) {
        let url = '';
    ...
    undoSoftDelete(codeSetId: string, restHandlerOptions?: RequestSettings) {

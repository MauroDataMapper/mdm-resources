...
export class MdmTreeItemResource extends MdmResource {
     ...
     * `403 Forbidden` - user is not an administrator.
     */
    modelSupersededModels(containerDomainType, modelDomainType, query, options) {
     ...
     * `403 Forbidden` - user is not an administrator.
     */
    documentationSupersededModels(containerDomainType, modelDomainType, query, options) {
     ...
     */
    search(containerDomainType, searchTerm, query, options) {
     ...
     */
    list(containerDomainType, query, options) {
     ...
     */
    get(containerDomainType, modelDomainType, id, query, options) {
     ...
     * @see {@link MdmTreeItemResource.list}
     */
    getExpandedTree(modelDomainType, id, query, options) {
   ...
   */
     ...
     */
    ancestors(containerDomainType, multiFacetAwareDomainType, id, query, options) {

...
export class MdmMergeResource extends MdmResource {
     ...
     */
    currentMainBranch(domainType, id, query, options) {
     ...
     */
    mergeDiff(domainType, sourceId, targetId, query, options) {
        const queryString = this.generateQueryString(Object.assign({ isLegacy: false }, query));
     ...
     */
    mergeInto(domainType, sourceId, targetId, data, options) {

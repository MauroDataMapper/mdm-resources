 ...
 */
export declare type MergableMultiFacetAwareDomainType = MultiFacetAwareDomainType.DataModels | MultiFacetAwareDomainType.ReferenceDataModels | MultiFacetAwareDomainType.Terminologies | MultiFacetAwareDomainType.VersionedFolders;
/**
 ...
 */
export declare type MainBranchItem = Modelable & Branchable & {
    [key: string]: any;
};
export declare type MainBranchResponse = MdmResponse<MainBranchItem>;
/**
 * Represents the type of merge operation applied to a {@link MergeDiffItem}.
 */
export declare enum MergeDiffType {
    /**
 ...
 */
export declare enum MergeConflictResolution {
    /**
...
export declare type MergeDiffResponse = MdmResponse<MergeDiff>;
/**

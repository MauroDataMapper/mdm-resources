...
export class MdmDataClassResource extends MdmResource {
     ...
     * `200 OK` - will return a {@link DataClassDetailResponse} containing a {@link DataClassDetail} object.
     */
    importDataClass(dataModelId, dataClassId, otherDataModelId, otherDataClassId, options) {
        const url = `${this.apiEndpoint}/dataModels/${dataModelId}/dataClasses/${dataClassId}/dataClasses/${otherDataModelId}/${otherDataClassId}`;
     ...
     * On success, the response will be a `204 No Content` and the response body will be empty.
     */
    removeImportedDataClass(dataModelId, dataClassId, otherDataModelId, otherDataClassId, options) {
        const url = `${this.apiEndpoint}/dataModels/${dataModelId}/dataClasses/${dataClassId}/dataClasses/${otherDataModelId}/${otherDataClassId}`;
     ...
     * `200 OK` - will return a {@link DataClassDetailResponse} containing a {@link DataClassDetail} object.
     */
    importDataElement(dataModelId, dataClassId, otherDataModelId, otherDataClassId, otherDataElementId, options) {
     ...
     * On success, the response will be a `204 No Content` and the response body will be empty.
     */
    removeImportedDataElement(dataModelId, dataClassId, otherDataModelId, otherDataClassId, otherDataElementId, options) {
        const url = `${this.apiEndpoint}/dataModels/${dataModelId}/dataClasses/${dataClassId}/dataElements/${otherDataModelId}/${otherDataClassId}/${otherDataElementId}`;
        return this.simpleDelete(url, {}, options);
    }
    /**
     ...
     * `200 OK` - will return a {@link DataClassDetailResponse} containing a {@link DataClassDetail} object.
     */
    addExtendDataClass(dataModelId, dataClassId, otherDataModelId, otherDataClassId, options) {
     ...
     * On success, the response will be a `204 No Content` and the response body will be empty.
     */
    removeExtendDataClass(dataModelId, dataClassId, otherDataModelId, otherDataClassId, options) {
        const url = `${this.apiEndpoint}/dataModels/${dataModelId}/dataClasses/${dataClassId}/extends/${otherDataModelId}/${otherDataClassId}`;
        return this.simpleDelete(url, {}, options);
    }
}

...
export class MdmVersionedFolderResource extends MdmResource {
     ...
     */
    saveToFolder(folderId, data, options) {
     ...
     * @see {@link MdmVersionedFolderResource.get}
     */
    listInFolder(folderId, query, options) {
        const url = `${this.apiEndpoint}/folders/${folderId}/versionedFolders`;
        return this.simpleGet(url, query, options);
    }
    /**
     ...
     */
    remove(versionedFolderId, query, options) {
     ...
     */
    removeFromFolder(folderId, versionedFolderId, query, options) {
     ...
     */
    update(versionedFolderId, data, options) {
        const url = `${this.apiEndpoint}/versionedFolders/${versionedFolderId}`;
     ...
     */
    updateInFolder(folderId, versionedFolderId, data, options) {
        const url = `${this.apiEndpoint}/folders/${folderId}/versionedFolders/${versionedFolderId}`;
        return this.simplePut(url, data, options);
    }
    /**
     ...
     */
    get(versionedFolderId, query, options) {
        const url = `${this.apiEndpoint}/versionedFolders/${versionedFolderId}`;
        return this.simpleGet(url, query, options);
    }
    /**
     ...
     * @see {@link MdmVersionedFolderResource.get}
     */
    getFromFolder(folderId, versionedFolderId, query, options) {
        const url = `${this.apiEndpoint}/folders/${folderId}/versionedFolders/${versionedFolderId}`;
        return this.simpleGet(url, query, options);
    }
    /**
     ...
     * @see {@link MdmVersionedFolderResource.newForkModel}
     */
    newDocumentationVersion(id, data, options) {

...
export class MdmDataElementResource extends MdmResource {
    suggestLinks(dataModelId, dataClassId, dataElementId, otherDataModelId, query, options) {
     ...
     */
    save(dataModelId, dataClassId, data, options) {
     ...
     */
    list(dataModelId, dataClassId, query, options) {
        const url = `${this.apiEndpoint}/dataModels/${dataModelId}/dataClasses/${dataClassId}/dataElements`;
        return this.simpleGet(url, query, options);
    }
    listWithDataType(dataModelId, dataTypeId, query, options) {
     ...
     */
    remove(dataModelId, dataClassId, dataElementId, query, options) {
     ...
     * `200 OK` - will return a {@link DataElementDetailResponse} containing a {@link DataElementDetail} object.
     */
    update(dataModelId, dataClassId, dataElementId, data, options) {
        const url = `${this.apiEndpoint}/dataModels/${dataModelId}/dataClasses/${dataClassId}/dataElements/${dataElementId}`;
     ...
     * `200 OK` - will return a {@link DataElementDetailResponse} containing a {@link DataElementDetail} object.
     */
    get(dataModelId, dataClassId, dataElementId, query, options) {
        let url = '';
     ...
     */
    copyDataElement(dataModelId, dataClassId, otherDataModelId, otherDataClassId, dataElementId, options) {

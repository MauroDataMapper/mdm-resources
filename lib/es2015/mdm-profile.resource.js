...
export class MdmProfileResource extends MdmResource {
     ...
     */
    usedProfiles(catalogueItemDomainType, catalogueItemId, query, options) {
     ...
     * `200 OK` - will return a {@link ProfileSummaryIndexResponse} containing a list of {@link ProfileSummary} objects.
     */
    unusedProfiles(catalogueItemDomainType, catalogueItemId, query, options) {
     ...
     */
    otherMetadata(catalogueItemDomainType, catalogueItemId, query, options) {
     ...
     */
    profile(catalogueItemDomainType, catalogueItemId, profileNamespace, profileName, profileVersion, query, options) {
     ...
     * `200 OK` - will return a {@link ProfileResponse} containing a {@link Profile}.
     */
    saveProfile(catalogueItemDomainType, catalogueItemId, profileNamespace, profileName, data, profileVersion, options) {
        let url = `${this.apiEndpoint}/${catalogueItemDomainType}/${catalogueItemId}/profile/${profileNamespace}/${profileName}`;
        if (profileVersion) {
            url += `/${profileVersion}`;
        }
     ...
     */
    deleteProfile(catalogueItemDomainType, catalogueItemId, profileNamespace, profileName, profileVersion, query, options) {
        let url = `${this.apiEndpoint}/${catalogueItemDomainType}/${catalogueItemId}/profile/${profileNamespace}/${profileName}`;
        if (profileVersion) {
            url += `/${profileVersion}`;
        }
     ...
     * `200 OK` - will return a {@link ProfileResponse} containing a {@link Profile}.
     */
    validateProfile(profileNamespace, profileName, catalogueItemDomainType, catalogueItemId, data) {

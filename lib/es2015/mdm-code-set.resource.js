...
export class MdmCodeSetResource extends MdmResource {
     ...
     */
    finalise(codeSetId, data, options) {
        const url = `${this.apiEndpoint}/codeSets/${codeSetId}/finalise`;
        return this.simplePut(url, data, options);
    }
    newBranchModelVersion(codeSetId, data, restHandlerOptions) {
        const url = `${this.apiEndpoint}/codeSets/${codeSetId}/newBranchModelVersion`;
        return this.simplePut(url, data, restHandlerOptions);
    }
    newForkModel(codeSetId, data, restHandlerOptions) {
     ...
     * `200 OK` - will return a {@link CodeSetDetailResponse} containing a {@link CodeSetDetail} object.
     */
    addToFolder(folderId, data, options) {
    ...
    moveCodeSetToFolder(codeSetId, folderId, data, restHandlerOptions) {
     ...
     */
    remove(codeSetId, query, options) {
    ...
    latestModelVersion(codeSetId, queryStringParams, restHandlerOptions) {
        const url = `${this.apiEndpoint}/codeSets/${codeSetId}/latestModelVersion`;
        return this.simpleGet(url, queryStringParams, restHandlerOptions);
    }
    latestFinalisedModel(codeSetId, queryStringParams, restHandlerOptions) {
        const url = `${this.apiEndpoint}/codeSets/${codeSetId}/latestFinalisedModel`;
        return this.simpleGet(url, queryStringParams, restHandlerOptions);
    }
    modelVersionTree(codeSetId, queryStringParams, restHandlerOptions) {
     ...
     */
    simpleModelVersionTree(codeSetId, query, options) {
     ...
     */
    undoSoftDelete(codeSetId, options) {

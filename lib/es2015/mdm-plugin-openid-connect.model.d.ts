...
export declare type AuthorizationDisplayType = 'PAGE' | 'POPUP' | 'TOUCH' | 'WRAP';
export declare type AuthorizationPromptType = 'NONE' | 'LOGIN' | 'CONSENT' | 'SELECT_ACCOUNT';
/**
...
export declare type PublicOpenIdConnectProvidersIndexResponse = MdmResponse<PublicOpenIdConnectProvider[]>;
export declare type OpenIdConnectProvidersDetailResponse = MdmResponse<OpenIdConnectProviderDetail>;
/**
...
export declare type OpenIdConnectProviderUpdatePayload = StandardOpenIdConnectProviderPayload | NonStandardOpenIdConnectProviderPayload;
/**

...
var MdmSessionResource = /** @class */ (function (_super) {
    ...
    MdmSessionResource.prototype.keepAlive = function (queryStringParams) {
        var url = this.apiEndpoint + "/session/keepAlive";
        return this.simpleGet(url, queryStringParams);
    };
    MdmSessionResource.prototype.activeSessions = function (queryStringParams) {
        var url = this.apiEndpoint + "/session/activeSessions";
        return this.simpleGet(url, queryStringParams);
    };
    MdmSessionResource.prototype.isAuthenticated = function (sessionId, queryStringParams) {

...
var MdmSessionResource = /** @class */ (function (_super) {
    ...
    MdmSessionResource.prototype.keepAlive = function (options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/session/keepAlive";
        return this.simpleGet(url, options);
    };
    MdmSessionResource.prototype.activeSessions = function (options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/session/activeSessions";
        return this.simpleGet(url, options);
    };
    MdmSessionResource.prototype.isAuthenticated = function (sessionId, options) {
        if (options === void 0) { options = {}; }

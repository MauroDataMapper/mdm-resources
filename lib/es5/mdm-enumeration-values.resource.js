...
var MdmEnumerationValuesResource = /** @class */ (function (_super) {
    ...
    //   }
    MdmEnumerationValuesResource.prototype.saveToEnumeratedType = function (dataModelId, enumerationTypeId, data) {
    ...
    MdmEnumerationValuesResource.prototype.listForEnumeratedType = function (dataModelId, enumerationTypeId, queryStringParams) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/enumerationTypes/" + enumerationTypeId + "/enumerationValues";
        return this.simpleGet(url, queryStringParams);
    };
    MdmEnumerationValuesResource.prototype.saveToDataType = function (dataModelId, dataTypeId, data) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataTypes/" + dataTypeId + "/enumerationValues";
        return this.simplePost(url, data);
    };
    MdmEnumerationValuesResource.prototype.listForDataType = function (dataModelId, dataTypeId, queryStringParams) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataTypes/" + dataTypeId + "/enumerationValues";
        return this.simpleGet(url, queryStringParams);
    };
    MdmEnumerationValuesResource.prototype.removeFromEnumeratedType = function (dataModelId, enumerationTypeId, enumerationValueId, queryStringParams) {
    ...
    MdmEnumerationValuesResource.prototype.updateInEnumeratedType = function (dataModelId, enumerationTypeId, enumerationValueId, data) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/enumerationTypes/" + enumerationTypeId + "/enumerationValues/" + enumerationValueId;
        return this.simplePut(url, data);
    };
    MdmEnumerationValuesResource.prototype.getFromEnumeratedType = function (dataModelId, enumerationTypeId, enumerationValueId, queryStringParams) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/enumerationTypes/" + enumerationTypeId + "/enumerationValues/" + enumerationValueId;
        return this.simpleGet(url, queryStringParams);
    };
    MdmEnumerationValuesResource.prototype.removeFromDataType = function (dataModelId, dataTypeId, enumerationValueId, queryStringParams) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataTypes/" + dataTypeId + "/enumerationValues/" + enumerationValueId;
        return this.simpleDelete(url, queryStringParams);
    };
    MdmEnumerationValuesResource.prototype.updateInDataType = function (dataModelId, dataTypeId, enumerationValueId, data) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataTypes/" + dataTypeId + "/enumerationValues/" + enumerationValueId;
        return this.simplePut(url, data);
    };
    MdmEnumerationValuesResource.prototype.getFromDataType = function (dataModelId, dataTypeId, enumerationValueId, queryStringParams) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataTypes/" + dataTypeId + "/enumerationValues/" + enumerationValueId;
        return this.simpleGet(url, queryStringParams);
    };

...
var MdmGroupRoleResource = /** @class */ (function (_super) {
    ...
    MdmGroupRoleResource.prototype.save = function (data) {
        var url = this.apiEndpoint + "/admin/groupRoles";
        return this.simplePut(url, data);
    };
    MdmGroupRoleResource.prototype.list = function (queryStringParams) {
        var url = this.apiEndpoint + "/admin/groupRoles";
        return this.simpleGet(url, queryStringParams);
    };
    MdmGroupRoleResource.prototype.applicationGroupRoles = function (queryStringParams) {
        var url = this.apiEndpoint + "/admin/applicationGroupRoles";
        return this.simpleGet(url, queryStringParams);
    };
    MdmGroupRoleResource.prototype.remove = function (groupRoleId, queryStringParams) {
        var url = this.apiEndpoint + "/admin/groupRoles/" + groupRoleId;
        return this.simpleDelete(url, queryStringParams);
    };
    MdmGroupRoleResource.prototype.update = function (groupRoleId, data) {
        var url = this.apiEndpoint + "/admin/groupRoles/" + groupRoleId;
        return this.simplePut(url, data);
    };
    MdmGroupRoleResource.prototype.get = function (groupRoleId, queryStringParams) {
        var url = this.apiEndpoint + "/admin/groupRoles/" + groupRoleId;
        return this.simpleGet(url, queryStringParams);
    };
    MdmGroupRoleResource.prototype.listForSecurableResource = function (securableResourceDomainType, securableResourceId, queryStringParams) {

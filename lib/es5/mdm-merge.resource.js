...
var MdmMergeResource = /** @class */ (function (_super) {
     ...
     * `200 OK` - will return a object containing the main branch.
     */
    MdmMergeResource.prototype.mergeDiff = function (modelDomainType, sourceId, targetId, query, options) {
        var url = this.apiEndpoint + "/" + modelDomainType + "/" + sourceId + "/mergeDiff/" + targetId;
        return this.simpleGet(url, query, options);
    };

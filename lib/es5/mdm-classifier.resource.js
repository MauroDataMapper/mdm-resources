...
var MdmClassifierResource = /** @class */ (function (_super) {
    ...
    // }
    MdmClassifierResource.prototype.save = function (data) {
        var url = this.apiEndpoint + "/classifiers";
        return this.simplePost(url, data);
    };
    MdmClassifierResource.prototype.saveChildrenOf = function (classifierId, data) {
        var url = this.apiEndpoint + "/classifiers/" + classifierId + "/classifiers";
        return this.simplePost(url, data);
    };
    MdmClassifierResource.prototype.addToCatalogueItem = function (catalogueItemDomainType, catalogueItemId, data) {
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/classifiers";
        return this.simplePost(url, data);
    };
    MdmClassifierResource.prototype.list = function (queryStringParams) {
        var url = this.apiEndpoint + "/classifiers";
        return this.simpleGet(url, queryStringParams);
    };
    MdmClassifierResource.prototype.listChildrenOf = function (classifierId, queryStringParams) {
        var url = this.apiEndpoint + "/classifiers/" + classifierId + "/classifiers";
        return this.simpleGet(url, queryStringParams);
    };
    MdmClassifierResource.prototype.listCatalogueItemsFor = function (classifierId, queryStringParams) {
        var url = this.apiEndpoint + "/classifiers/" + classifierId + "/catalogueItems";
        return this.simpleGet(url, queryStringParams);
    };
    MdmClassifierResource.prototype.listForCatalogueItem = function (catalogueItemDomainType, catalogueItemId, queryStringParams) {
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/classifiers";
        return this.simpleGet(url, queryStringParams);
    };
    MdmClassifierResource.prototype.remove = function (classifierId, queryStringParams) {
        var url = this.apiEndpoint + "/classifiers/" + classifierId;
        return this.simpleDelete(url, queryStringParams);
    };
    MdmClassifierResource.prototype.removeChildOf = function (classifierId, childId, queryStringParams) {
        var url = this.apiEndpoint + "/classifiers/" + classifierId + "/classifiers/" + childId;
        return this.simpleDelete(url, queryStringParams);
    };
    MdmClassifierResource.prototype.removeFromCatalogueItem = function (catalogueItemDomainType, catalogueItemId, classifierId, queryStringParams) {
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/classifiers/" + classifierId;
        return this.simpleDelete(url, queryStringParams);
    };
    MdmClassifierResource.prototype.update = function (classifierId, data) {
        var url = this.apiEndpoint + "/classifiers/" + classifierId;
        return this.simplePut(url, data);
    };
    MdmClassifierResource.prototype.updateChildOf = function (classifierId, childId, data) {
        var url = this.apiEndpoint + "/classifiers/" + classifierId + "/classifiers/" + childId;
        return this.simplePut(url, data);
    };
    MdmClassifierResource.prototype.get = function (classifierId, queryStringParams) {
        var url = this.apiEndpoint + "/classifiers/" + classifierId;
        return this.simpleGet(url, queryStringParams);
    };
    MdmClassifierResource.prototype.getChildOf = function (classifierId, childId, queryStringParams) {
        var url = this.apiEndpoint + "/classifiers/" + classifierId + "/classifiers/" + childId;
        return this.simpleGet(url, queryStringParams);
    };
    MdmClassifierResource.prototype.getFromCatalogueItem = function (catalogueItemDomainType, catalogueItemId, classifierId, queryStringParams) {
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/classifiers/" + classifierId;
        return this.simpleGet(url, queryStringParams);
    };

...
var MdmTerminologyResource = /** @class */ (function (_super) {
    ...
    //   }
    MdmTerminologyResource.prototype.importers = function (queryStringParams) {
        var url = this.apiEndpoint + "/terminologies/providers/importers";
        return this.simpleGet(url, queryStringParams);
    };
    MdmTerminologyResource.prototype.exporters = function (queryStringParams) {
        var url = this.apiEndpoint + "/terminologies/providers/exporters";
        return this.simpleGet(url, queryStringParams);
    };
    MdmTerminologyResource.prototype.importModels = function (namespace, name, version, data) {
        var url = this.apiEndpoint + "/terminologies/import/" + namespace + "/" + name + "/" + version;
        return this.simplePost(url, data);
    };
    MdmTerminologyResource.prototype.exportModels = function (namespace, name, version, data) {
        var url = this.apiEndpoint + "/terminologies/export/" + namespace + "/" + name + "/" + version;
        return this.simplePost(url, data);
    };
    MdmTerminologyResource.prototype.newModelVersion = function (terminologyId, data) {
        var url = this.apiEndpoint + "/terminologies/" + terminologyId + "/newModelVersion";
        return this.simplePut(url, data);
    };
    MdmTerminologyResource.prototype.newDocumentationVersion = function (terminologyId, data) {
        var url = this.apiEndpoint + "/terminologies/" + terminologyId + "/newDocumentationVersion";
        return this.simplePut(url, data);
    };
    MdmTerminologyResource.prototype.finalise = function (terminologyId, data) {
        var url = this.apiEndpoint + "/terminologies/" + terminologyId + "/finalise";
        return this.simplePut(url, data);
    };
    MdmTerminologyResource.prototype.tree = function (terminologyId, queryStringParams) {
        var url = this.apiEndpoint + "/terminologies/" + terminologyId + "/tree";
        return this.simpleGet(url, queryStringParams);
    };
    MdmTerminologyResource.prototype.alterFolder = function (terminologyId, folderId, data) {
        var url = this.apiEndpoint + "/terminologies/" + terminologyId + "/folder/" + folderId;
        return this.simplePut(url, data);
    };
    MdmTerminologyResource.prototype.diff = function (terminologyId, otherModelId, queryStringParams) {
        var url = this.apiEndpoint + "/terminologies/" + terminologyId + "/diff/" + otherModelId;
        return this.simpleGet(url, queryStringParams);
    };
    MdmTerminologyResource.prototype.exportModel = function (terminologyId, exporterNamespace, exporterName, exporterVersion, queryStringParams) {
        var url = this.apiEndpoint + "/codeSets/" + terminologyId + "/export/" + exporterNamespace + "/" + exporterName + "/" + exporterVersion;
        return this.simpleGet(url, queryStringParams);
    };
    MdmTerminologyResource.prototype.list = function (queryStringParams) {
        var url = this.apiEndpoint + "/terminologies";
        return this.simpleGet(url, queryStringParams);
    };
    MdmTerminologyResource.prototype.removeAll = function (queryStringParams) {
        var url = this.apiEndpoint + "/terminologies";
        return this.simpleDelete(url, queryStringParams);
    };
    MdmTerminologyResource.prototype.remove = function (terminologyId, queryStringParams) {
        var url = this.apiEndpoint + "/terminologies/" + terminologyId;
        return this.simpleDelete(url, queryStringParams);
    };
    MdmTerminologyResource.prototype.update = function (terminologyId, data) {
        var url = this.apiEndpoint + "/terminologies/" + terminologyId;
        return this.simplePut(url, data);
    };
    MdmTerminologyResource.prototype.get = function (terminologyId, queryStringParams) {
        var url = this.apiEndpoint + "/terminologies/" + terminologyId;
        return this.simpleGet(url, queryStringParams);
    };
    MdmTerminologyResource.prototype.termRelationships = function (terminologyId, termRelationshipTypeId, queryStringParams) {
        var url = this.apiEndpoint + "/terminologies/" + terminologyId + "/termRelationshipTypes/" + termRelationshipTypeId + "/termRelationships";
        return this.simpleGet(url, queryStringParams);
    };
    MdmTerminologyResource.prototype.getTermRelationship = function (terminologyId, termRelationshipTypeId, termRelationshipId, queryStringParams) {

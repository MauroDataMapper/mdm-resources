...
var MdmTerminologyResource = /** @class */ (function (_super) {
     ...
     */
    MdmTerminologyResource.prototype.simpleModelVersionTree = function (terminologyId, query, options) {
        var url = this.apiEndpoint + "/terminologies/" + terminologyId + "/simpleModelVersionTree";
        return this.simpleGet(url, query, options);
    };
    /**

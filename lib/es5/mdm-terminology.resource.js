...
var MdmTerminologyResource = /** @class */ (function (_super) {
     ...
     */
    MdmTerminologyResource.prototype.diff = function (leftModelId, rightModelId, query, options) {
        var url = this.apiEndpoint + "/terminologies/" + leftModelId + "/diff/" + rightModelId;
     ...
     */
    MdmTerminologyResource.prototype.modelVersionTree = function (id, query, options) {
        var url = this.apiEndpoint + "/terminologies/" + id + "/modelVersionTree";
        return this.simpleGet(url, query, options);
    };
    /**
     ...
     */
    MdmTerminologyResource.prototype.simpleModelVersionTree = function (id, query, options) {
        var url = this.apiEndpoint + "/terminologies/" + id + "/simpleModelVersionTree";
        return this.simpleGet(url, query, options);
    };
    /**

...
var MdmDataElementResource = /** @class */ (function (_super) {
    ...
    //   }
    MdmDataElementResource.prototype.suggestLinks = function (dataModelId, dataClassId, dataElementId, otherDataModelId, queryStringParams, restHandlerOptions) {
    ...
    MdmDataElementResource.prototype.save = function (dataModelId, dataClassId, data, restHandlerOptions) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataClasses/" + dataClassId + "/dataElements";
        return this.simplePost(url, data, restHandlerOptions);
    };
    MdmDataElementResource.prototype.list = function (dataModelId, dataClassId, queryStringParams, restHandlerOptions) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataClasses/" + dataClassId + "/dataElements";
        return this.simpleGet(url, queryStringParams, restHandlerOptions);
    };
    MdmDataElementResource.prototype.listWithDataType = function (dataModelId, dataTypeId, queryStringParams, restHandlerOptions) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataTypes/" + dataTypeId + "/dataElements";
        return this.simpleGet(url, queryStringParams, restHandlerOptions);
    };
    MdmDataElementResource.prototype.remove = function (dataModelId, dataClassId, dataElementId, queryStringParams, restHandlerOptions) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataClasses/" + dataClassId + "/dataElements/" + dataElementId;
        return this.simpleDelete(url, queryStringParams, restHandlerOptions);
    };
    MdmDataElementResource.prototype.update = function (dataModelId, dataClassId, dataElementId, data, restHandlerOptions) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataClasses/" + dataClassId + "/dataElements/" + dataElementId;
        return this.simplePut(url, data, restHandlerOptions);
    };
    MdmDataElementResource.prototype.get = function (dataModelId, dataClassId, dataElementId, queryStringParams, restHandlerOptions) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataClasses/" + dataClassId + "/dataElements/" + dataElementId;
        return this.simpleGet(url, queryStringParams, restHandlerOptions);
    };
    MdmDataElementResource.prototype.copyDataElement = function (dataModelId, dataClassId, otherDataModelId, otherDataClassId, dataElementId, data, restHandlerOptions) {

...
var MdmFolderResource = /** @class */ (function (_super) {
    ...
    //   }
    MdmFolderResource.prototype.save = function (data) {
        var url = this.apiEndpoint + "/folders";
        return this.simplePost(url, data);
    };
    MdmFolderResource.prototype.saveChildrenOf = function (folderId, data) {
        var url = this.apiEndpoint + "/folders/" + folderId + "/folders";
        return this.simplePost(url, data);
    };
    MdmFolderResource.prototype.list = function (queryStringParams) {
        var url = this.apiEndpoint + "/folders";
        return this.simpleGet(url, queryStringParams);
    };
    MdmFolderResource.prototype.listChildrenOf = function (folderId, queryStringParams) {
        var url = this.apiEndpoint + "/folders/" + folderId + "/folders";
        return this.simpleGet(url, queryStringParams);
    };
    MdmFolderResource.prototype.remove = function (folderId, queryStringParams) {
        var url = this.apiEndpoint + "/folders/" + folderId;
        return this.simpleDelete(url, queryStringParams);
    };
    MdmFolderResource.prototype.removeChildOf = function (folderId, childId, queryStringParams) {
        var url = this.apiEndpoint + "/folders/" + folderId + "/folders/" + childId;
        return this.simpleDelete(url, queryStringParams);
    };
    MdmFolderResource.prototype.update = function (folderId, data, queryStringParams) {
        var url = this.apiEndpoint + "/folders/" + folderId;
        return this.simplePut(url, data);
    };
    MdmFolderResource.prototype.updateChildOf = function (folderId, childId, data, queryStringParams) {
        var url = this.apiEndpoint + "/folders/" + folderId + "/folders/" + childId;
        return this.simplePut(url, data);
    };
    MdmFolderResource.prototype.get = function (folderId, queryStringParams) {
        var url = this.apiEndpoint + "/folders/" + folderId;
        return this.simpleGet(url, queryStringParams);
    };
    MdmFolderResource.prototype.getChildOf = function (folderId, childId, queryStringParams) {
        var url = this.apiEndpoint + "/folders/" + folderId + "/folders/" + childId;
        return this.simpleGet(url, queryStringParams);
    };
    MdmFolderResource.prototype.addCondeSets = function (folderId, data) {
        var url = this.apiEndpoint + "/folders/" + folderId + "/codeSets";
        return this.simplePost(url, data);
    };
    MdmFolderResource.prototype.codeSets = function (folderId, queryStringParams) {
        var url = this.apiEndpoint + "/folders/" + folderId + "/codeSets";
        return this.simpleGet(url, queryStringParams);
    };
    MdmFolderResource.prototype.alterCodeSetFolder = function (codeSetId, folderId, data) {
        var url = this.apiEndpoint + "/folders/" + folderId + "/codeSets/" + codeSetId;
        return this.simplePut(url, data);
    };
    MdmFolderResource.prototype.addTerminologies = function (folderId, data) {
        var url = this.apiEndpoint + "/folders/" + folderId + "/terminologies";
        return this.simplePost(url, data);
    };
    MdmFolderResource.prototype.terminologies = function (folderId, queryStringParams) {
        var url = this.apiEndpoint + "/folders/" + folderId + "/terminologies";
        return this.simpleGet(url, queryStringParams);
    };
    MdmFolderResource.prototype.alterTerminologyFolder = function (terminologyId, folderId, data) {

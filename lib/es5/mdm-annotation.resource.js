...
var MdmAnnotationResource = /** @class */ (function (_super) {
    ...
    MdmAnnotationResource.prototype.save = function (catalogueItemDomainType, catalogueItemId, data) {
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/annotations";
        return this.simplePost(url, data);
    };
    MdmAnnotationResource.prototype.saveChildren = function (catalogueItemDomainType, catalogueItemId, annotationId, data) {
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/annotations/" + annotationId + "/annotations";
        return this.simplePost(url, data);
    };
    MdmAnnotationResource.prototype.list = function (catalogueItemDomainType, catalogueItemId, queryStringParams) {
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/annotations";
        return this.simpleGet(url, queryStringParams);
    };
    MdmAnnotationResource.prototype.listChildren = function (catalogueItemDomainType, catalogueItemId, annotationId, queryStringParams) {
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/annotations/" + annotationId + "/annotations";
        return this.simpleGet(url, queryStringParams);
    };
    MdmAnnotationResource.prototype.remove = function (catalogueItemDomainType, catalogueItemId, annotationId, queryStringParams) {
    ...
    MdmAnnotationResource.prototype.removeChild = function (catalogueItemDomainType, catalogueItemId, annotationId, childId, queryStringParams) {
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/annotations/" + annotationId + "/annotations/" + childId;
        return this.simpleDelete(url, queryStringParams);
    };
    MdmAnnotationResource.prototype.get = function (catalogueItemDomainType, catalogueItemId, annotationId, queryStringParams) {
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/annotations/" + annotationId;
        return this.simpleGet(url, queryStringParams);
    };
    MdmAnnotationResource.prototype.getChild = function (catalogueItemDomainType, catalogueItemId, annotationId, childId, queryStringParams) {
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/annotations/" + annotationId + "/annotations/" + childId;
        return this.simpleGet(url, queryStringParams);
    };

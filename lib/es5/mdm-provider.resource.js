...
var MdmProviderResource = /** @class */ (function (_super) {
    ...
    MdmProviderResource.prototype.exporters = function (options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/admin/providers/exporters";
        return this.simpleGet(url, options);
    };
    MdmProviderResource.prototype.emailers = function (options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/admin/providers/emailers";
        return this.simpleGet(url, options);
    };
    MdmProviderResource.prototype.dataLoaders = function (options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/admin/providers/dataLoaders";
        return this.simpleGet(url, options);
    };
    MdmProviderResource.prototype.importers = function (options) {
        if (options === void 0) { options = {}; }

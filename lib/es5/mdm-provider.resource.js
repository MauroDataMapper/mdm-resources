...
var MdmProviderResource = /** @class */ (function (_super) {
    ...
    MdmProviderResource.prototype.exporters = function (queryStringParams) {
        var url = this.apiEndpoint + "/admin/providers/exporters";
        return this.simpleGet(url, queryStringParams);
    };
    MdmProviderResource.prototype.emailers = function (queryStringParams) {
        var url = this.apiEndpoint + "/admin/providers/emailers";
        return this.simpleGet(url, queryStringParams);
    };
    MdmProviderResource.prototype.dataLoaders = function (queryStringParams) {
        var url = this.apiEndpoint + "/admin/providers/dataLoaders";
        return this.simpleGet(url, queryStringParams);
    };
    MdmProviderResource.prototype.importers = function (queryStringParams) {

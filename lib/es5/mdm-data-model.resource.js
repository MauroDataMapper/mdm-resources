...
var MdmDataModelResource = /** @class */ (function (_super) {
     ...
     */
    MdmDataModelResource.prototype.simpleModelVersionTree = function (dataModelId, query, options) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/simpleModelVersionTree";
        return this.simpleGet(url, query, options);
    };
    /**
    ...
    MdmDataModelResource.prototype.importDataType = function (dataModelId, otherDataModelId, otherDataTypeId, options) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataTypes/" + otherDataModelId + "/" + otherDataTypeId;
        return this.simplePut(url, {}, options);
    };
    MdmDataModelResource.prototype.removeImportedDataType = function (dataModelId, otherDataModelId, otherDataTypeId, options) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataTypes/" + otherDataModelId + "/" + otherDataTypeId;
        return this.simpleDelete(url, {}, options);
    };
    MdmDataModelResource.prototype.importDataClass = function (dataModelId, otherDataModelId, otherDataClassId, options) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataClasses/" + otherDataModelId + "/" + otherDataClassId;
        return this.simplePut(url, {}, options);
    };
    MdmDataModelResource.prototype.removeImportedDataClass = function (dataModelId, otherDataModelId, otherDataClassId, options) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataClasses/" + otherDataModelId + "/" + otherDataClassId;
        return this.simpleDelete(url, {}, options);
    };

...
var MdmDataModelResource = /** @class */ (function (_super) {
    ...
    MdmDataModelResource.prototype.addToFolder = function (folderId, data, queryStringParams, restHandlerOptions) {
        var queryString = this.generateQueryString(queryStringParams);
    ...
    MdmDataModelResource.prototype.undoSoftDelete = function (dataModelId, restHandlerOptions) {

...
var MdmDataModelResource = /** @class */ (function (_super) {
    ...
    MdmDataModelResource.prototype.latestVersion = function (dataModelId, queryStringParams, restHandlerOptions) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/latestVersion";
        return this.simpleGet(url, queryStringParams, restHandlerOptions);
    };

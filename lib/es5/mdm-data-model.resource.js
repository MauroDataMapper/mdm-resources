...
var MdmDataModelResource = /** @class */ (function (_super) {
    ...
    MdmDataModelResource.prototype.modelVersionTree = function (modelId, queryStringParams, restHandlerOptions) {
        var url = this.apiEndpoint + "/dataModels/" + modelId + "/modelVersionTree";
        return this.simpleGet(url, queryStringParams, restHandlerOptions);
    };

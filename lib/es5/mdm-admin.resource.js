...
var MdmAdminResource = /** @class */ (function (_super) {
    ...
    // }
    MdmAdminResource.prototype.status = function (queryStringParams) {
        var url = this.apiEndpoint + "/admin/status";
        return this.simpleGet(url, queryStringParams);
    };
    MdmAdminResource.prototype.editProperties = function (data) {
        var url = this.apiEndpoint + "/admin/editProperties";
        return this.simplePost(url, data);
    };
    MdmAdminResource.prototype.rebuildLuceneIndexes = function (data) {
        var url = this.apiEndpoint + "/admin/rebuildLuceneIndexes";
        return this.simplePost(url, data);
    };
    MdmAdminResource.prototype.properties = function (queryStringParams) {
        var url = this.apiEndpoint + "/admin/properties";
        return this.simpleGet(url, queryStringParams);
    };
    MdmAdminResource.prototype.modules = function (queryStringParams) {
        var url = this.apiEndpoint + "/admin/modules";
        return this.simpleGet(url, queryStringParams);
    };
    MdmAdminResource.prototype.deletedModels = function (containerDomainType, modelDomainType, queryStringParams) {
        var url = this.apiEndpoint + "/admin/tree/" + containerDomainType + "/" + modelDomainType + "/deleted";
        return this.simpleGet(url, queryStringParams);
    };
    MdmAdminResource.prototype.modelSupersededModels = function (containerDomainType, modelDomainType, queryStringParams) {
        var url = this.apiEndpoint + "/admin/tree/" + containerDomainType + "/" + modelDomainType + "/modelSuperseded";
        return this.simpleGet(url, queryStringParams);
    };
    MdmAdminResource.prototype.documentationSupersededModels = function (containerDomainType, modelDomainType, queryStringParams) {
        var url = this.apiEndpoint + "/admin/tree/" + containerDomainType + "/" + modelDomainType + "/documentationSuperseded";
        return this.simpleGet(url, queryStringParams);
    };
    MdmAdminResource.prototype.emails = function (queryStringParams) {
        var url = this.apiEndpoint + "/admin/emails";
        return this.simpleGet(url, queryStringParams);
    };
    MdmAdminResource.prototype.activeSessions = function (data) {

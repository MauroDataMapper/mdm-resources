...
var MdmAdminResource = /** @class */ (function (_super) {
    ...
    // }
    MdmAdminResource.prototype.status = function (options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/admin/status";
        return this.simpleGet(url, options);
    };
    MdmAdminResource.prototype.editProperties = function (data, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/admin/editProperties";
        return this.simplePost(url, data, options);
    };
    MdmAdminResource.prototype.rebuildLuceneIndexes = function (data, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/admin/rebuildLuceneIndexes";
        return this.simplePost(url, data, options);
    };
    MdmAdminResource.prototype.properties = function (options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/admin/properties";
        return this.simpleGet(url, options);
    };
    MdmAdminResource.prototype.modules = function (options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/admin/modules";
        return this.simpleGet(url, options);
    };
    MdmAdminResource.prototype.deletedModels = function (containerDomainType, modelDomainType, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/admin/tree/" + containerDomainType + "/" + modelDomainType + "/deleted";
        return this.simpleGet(url, options);
    };
    MdmAdminResource.prototype.modelSupersededModels = function (containerDomainType, modelDomainType, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/admin/tree/" + containerDomainType + "/" + modelDomainType + "/modelSuperseded";
        return this.simpleGet(url, options);
    };
    MdmAdminResource.prototype.documentationSupersededModels = function (containerDomainType, modelDomainType, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/admin/tree/" + containerDomainType + "/" + modelDomainType + "/documentationSuperseded";
        return this.simpleGet(url, options);
    };
    MdmAdminResource.prototype.emails = function (options) {
        if (options === void 0) { options = {}; }

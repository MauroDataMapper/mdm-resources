...
export declare class MdmTerminologyResource extends MdmResource {
    ...
    newModelVersion(terminologyId: string, data: any, restHandlerOptions?: MdmRequestOptions): any;
    newDocumentationVersion(terminologyId: string, data: any, restHandlerOptions?: MdmRequestOptions): any;
    finalise(terminologyId: string, data: any, restHandlerOptions?: MdmRequestOptions): any;
    newBranchModelVersion(terminologyId: string, data: any, restHandlerOptions?: MdmRequestOptions): any;
    newForkModel(terminologyId: string, data: any, restHandlerOptions?: MdmRequestOptions): any;
    tree(terminologyId: string, queryStringParams?: QueryParameters, restHandlerOptions?: MdmRequestOptions): any;
    moveTerminologyToFolder(terminologyId: string, folderId: string, data: any, restHandlerOptions?: MdmRequestOptions): any;
    diff(terminologyId: string, otherModelId: string, queryStringParams?: QueryParameters, restHandlerOptions?: MdmRequestOptions): any;
    exportModel(terminologyId: string, exporterNamespace: any, exporterName: any, exporterVersion: any, queryStringParams?: QueryParameters, restHandlerOptions?: MdmRequestOptions): any;
    ...
    remove(terminologyId: string, queryStringParams?: QueryParameters, restHandlerOptions?: MdmRequestOptions): any;
    update(terminologyId: string, data: any, restHandlerOptions?: MdmRequestOptions): any;
    get(terminologyId: string, queryStringParams?: QueryParameters, restHandlerOptions?: MdmRequestOptions): any;
    termRelationships(terminologyId: string, termRelationshipTypeId: string, queryStringParams?: QueryParameters, restHandlerOptions?: MdmRequestOptions): any;
    getTermRelationship(terminologyId: string, termRelationshipTypeId: string, termRelationshipId: string, queryStringParams?: QueryParameters, restHandlerOptions?: MdmRequestOptions): any;
    removeReadByAuthenticated(terminologyId: string, queryStringParams?: QueryParameters, restHandlerOptions?: MdmRequestOptions): any;
    updateReadByAuthenticated(terminologyId: string, data?: any, restHandlerOptions?: MdmRequestOptions): any;
    removeReadByEveryone(terminologyId: string, queryStringParams?: QueryParameters, restHandlerOptions?: MdmRequestOptions): any;
    updateReadByEveryone(terminologyId: string, data?: any, restHandlerOptions?: MdmRequestOptions): any;
    latestModelVersion(terminologyId: string, queryStringParams?: QueryParameters, restHandlerOptions?: MdmRequestOptions): any;
    latestFinalisedModel(terminologyId: string, queryStringParams?: QueryParameters, restHandlerOptions?: MdmRequestOptions): any;
    modelVersionTree(terminologyId: string, queryStringParams?: QueryParameters, restHandlerOptions?: MdmRequestOptions): any;
    undoSoftDelete(terminologyId: string, restHandlerOptions?: MdmRequestOptions): any;
}

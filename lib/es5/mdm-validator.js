...
*/
var MdmValidator = /** @class */ (function () {
    function MdmValidator() {
    }
    MdmValidator.index = function (obj, i) {
        return obj[i];
    };
    MdmValidator.getProperty = function (obj, str) {
        // eslint-disable-next-line @typescript-eslint/unbound-method
        return str.split('.').reduce(this.index, obj);
    };
    MdmValidator.capitalize = function (str) {
        return str.charAt(0).toUpperCase() + str.slice(1);
    };
    MdmValidator.validateEmail = function (email) {
        var pattern = /^[_A-Za-z0-9-'!#%&=\/~\`\+\$\*\?\^\{\|\}]+(\.[_A-Za-z0-9-'!#%&=\/~\`\+\$\*\?\^\{\|\}]+)*@[_A-Za-z0-9-\+]+(\.[_A-Za-z0-9-\+]+)*(\.[A-Za-z]{2,})$/;
        return pattern.test(email);
    };
    MdmValidator.isDate = function (date) {
        if (!isNaN(date)) {
            return date instanceof Date;
        }
        return false;
    };
    MdmValidator.isEmpty = function (str) {
    ...
    MdmValidator.validateMultiplicities = function (min, max) {

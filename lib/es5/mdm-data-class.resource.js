...
var MdmDataClassResource = /** @class */ (function (_super) {
     ...
     * `200 OK` - will return a {@link DataClassDetailResponse} containing a {@link DataClassDetail} object.
     */
    MdmDataClassResource.prototype.importDataClass = function (dataModelId, dataClassId, otherDataModelId, otherDataClassId, options) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataClasses/" + dataClassId + "/dataClasses/" + otherDataModelId + "/" + otherDataClassId;
     ...
     * On success, the response will be a `204 No Content` and the response body will be empty.
     */
    MdmDataClassResource.prototype.removeImportedDataClass = function (dataModelId, dataClassId, otherDataModelId, otherDataClassId, options) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataClasses/" + dataClassId + "/dataClasses/" + otherDataModelId + "/" + otherDataClassId;
     ...
     * `200 OK` - will return a {@link DataClassDetailResponse} containing a {@link DataClassDetail} object.
     */
    MdmDataClassResource.prototype.importDataElement = function (dataModelId, dataClassId, otherDataModelId, otherDataClassId, otherDataElementId, options) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataClasses/" + dataClassId + "/dataElements/" + otherDataModelId + "/" + otherDataClassId + "/" + otherDataElementId;
        return this.simplePut(url, {}, options);
    };
    /**
     ...
     * On success, the response will be a `204 No Content` and the response body will be empty.
     */
    MdmDataClassResource.prototype.removeImportedDataElement = function (dataModelId, dataClassId, otherDataModelId, otherDataClassId, otherDataElementId, options) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataClasses/" + dataClassId + "/dataElements/" + otherDataModelId + "/" + otherDataClassId + "/" + otherDataElementId;
        return this.simpleDelete(url, {}, options);
    };
    /**
     ...
     * `200 OK` - will return a {@link DataClassDetailResponse} containing a {@link DataClassDetail} object.
     */
    MdmDataClassResource.prototype.addExtendDataClass = function (dataModelId, dataClassId, otherDataModelId, otherDataClassId, options) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataClasses/" + dataClassId + "/extends/" + otherDataModelId + "/" + otherDataClassId;
        return this.simplePut(url, {}, options);
    };
    /**
     ...
     * On success, the response will be a `204 No Content` and the response body will be empty.
     */
    MdmDataClassResource.prototype.removeExtendDataClass = function (dataModelId, dataClassId, otherDataModelId, otherDataClassId, options) {
        var url = this.apiEndpoint + "/dataModels/" + dataModelId + "/dataClasses/" + dataClassId + "/extends/" + otherDataModelId + "/" + otherDataClassId;
        return this.simpleDelete(url, {}, options);
    };

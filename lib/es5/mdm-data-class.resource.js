...
var MdmDataClassResource = /** @class */ (function (_super) {
    ...
    function MdmDataClassResource(resourcesConfig, restHandler) {
    ...
    MdmDataClassResource.prototype.get = function (dataModel, parentDataClass, id, action, options) {
        if (!options) {
            options = {};
        }
    ...
    MdmDataClassResource.prototype.post = function (dataModelId, id, action, options) {
        return this.postResource("dataModels/" + dataModelId + "/dataClasses/", id, action, options);
    };
    MdmDataClassResource.prototype.put = function (dataModelId, parentDataClassId, id, action, options) {
    ...
    MdmDataClassResource.prototype.delete = function (dataModelId, parentDataClassId, id) {
        if (parentDataClassId) {

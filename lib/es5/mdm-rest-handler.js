 ...
 * ```
 */
var DefaultMdmRestHandler = /** @class */ (function () {
    function DefaultMdmRestHandler() {
    }
    DefaultMdmRestHandler.prototype.process = function (url, options) {
    ...
    return DefaultMdmRestHandler;
}());
export { DefaultMdmRestHandler };

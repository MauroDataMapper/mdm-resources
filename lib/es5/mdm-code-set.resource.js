...
var MdmCodeSetResource = /** @class */ (function (_super) {
     ...
     */
    MdmCodeSetResource.prototype.simpleModelVersionTree = function (codeSetId, query, options) {
        var url = this.apiEndpoint + "/codeSets/" + codeSetId + "/simpleModelVersionTree";
        return this.simpleGet(url, query, options);
    };
    /**

...
var MdmCodeSetResource = /** @class */ (function (_super) {
     ...
     */
    MdmCodeSetResource.prototype.modelVersionTree = function (id, query, options) {
        var url = this.apiEndpoint + "/codeSets/" + id + "/modelVersionTree";
        return this.simpleGet(url, query, options);
    };
    /**
     ...
     */
    MdmCodeSetResource.prototype.simpleModelVersionTree = function (id, query, options) {
        var url = this.apiEndpoint + "/codeSets/" + id + "/simpleModelVersionTree";
        return this.simpleGet(url, query, options);
    };
    /**

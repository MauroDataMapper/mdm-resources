...
var MdmCodeSetResource = /** @class */ (function (_super) {
    ...
    MdmCodeSetResource.prototype.latestVersion = function (codeSetId, queryStringParams, restHandlerOptions) {
        var url = this.apiEndpoint + "/codeSets/" + codeSetId + "/latestVersion";
        return this.simpleGet(url, queryStringParams, restHandlerOptions);
    };

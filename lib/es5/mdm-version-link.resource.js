...
var MdmVersionLinkResource = /** @class */ (function (_super) {
    ...
    MdmVersionLinkResource.prototype.save = function (modelDomainType, modelId, data, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + modelDomainType + "/" + modelId + "/versionLinks";
        return this.simplePost(url, data, options);
    };
    MdmVersionLinkResource.prototype.list = function (modelDomainType, modelId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + modelDomainType + "/" + modelId + "/versionLinks";
        return this.simpleGet(url, options);
    };
    MdmVersionLinkResource.prototype.remove = function (modelDomainType, modelId, versionLinkId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + modelDomainType + "/" + modelId + "/versionLinks/" + versionLinkId;
        return this.simpleDelete(url, options);
    };
    MdmVersionLinkResource.prototype.update = function (modelDomainType, modelId, versionLinkId, data, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + modelDomainType + "/" + modelId + "/versionLinks/" + versionLinkId;
        return this.simplePut(url, data, options);
    };
    MdmVersionLinkResource.prototype.get = function (modelDomainType, modelId, versionLinkId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + modelDomainType + "/" + modelId + "/versionLinks/" + versionLinkId;
        return this.simpleGet(url, options);
    };

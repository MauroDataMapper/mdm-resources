...
var MdmSecurityResource = /** @class */ (function (_super) {
    ...
    MdmSecurityResource.prototype.login = function (data) {
        var url = this.apiEndpoint + "/authentication/login";
        return this.simplePost(url, data);
    };
    MdmSecurityResource.prototype.logout = function (queryStringParams) {
        var url = this.apiEndpoint + "/authentication/logout";
        return this.simpleGet(url, queryStringParams);
    };
    MdmSecurityResource.prototype.permissions = function (securableResourceDomainType, securableResourceId, queryStringParams) {

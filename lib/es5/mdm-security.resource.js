...
var MdmSecurityResource = /** @class */ (function (_super) {
    ...
    MdmSecurityResource.prototype.login = function (data, restHandlerOptions) {
        var url = this.apiEndpoint + "/authentication/login";
        return this.simplePost(url, data, restHandlerOptions);
    };
    MdmSecurityResource.prototype.logout = function (queryStringParams, restHandlerOptions) {
        var url = this.apiEndpoint + "/authentication/logout";
        return this.simpleGet(url, queryStringParams, restHandlerOptions);
    };
    MdmSecurityResource.prototype.permissions = function (securableResourceDomainType, securableResourceId, queryStringParams, restHandlerOptions) {

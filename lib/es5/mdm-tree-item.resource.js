...
var MdmTreeItemResource = /** @class */ (function (_super) {
    ...
    // }
    MdmTreeItemResource.prototype.deletedModels = function (containerDomainType, modelDomainType, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/admin/tree/" + containerDomainType + "/" + modelDomainType + "/deleted";
        return this.simpleGet(url, options);
    };
    MdmTreeItemResource.prototype.modelSupersededModels = function (containerDomainType, modelDomainType, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/admin/tree/" + containerDomainType + "/" + modelDomainType + "/modelSuperseded";
        return this.simpleGet(url, options);
    };
    MdmTreeItemResource.prototype.documentationSupersededModels = function (containerDomainType, modelDomainType, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/admin/tree/" + containerDomainType + "/" + modelDomainType + "/documentationSuperseded";
        return this.simpleGet(url, options);
    };
    MdmTreeItemResource.prototype.search = function (containerDomainType, searchTerm, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/tree/" + containerDomainType + "/search/" + searchTerm;
        return this.simpleGet(url, options);
    };
    MdmTreeItemResource.prototype.list = function (containerDomainType, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/tree/" + containerDomainType;
        return this.simpleGet(url, options);
    };
    MdmTreeItemResource.prototype.get = function (containerDomainType, catalogueItemDomainType, catalogueItemId, options) {
        if (options === void 0) { options = {}; }

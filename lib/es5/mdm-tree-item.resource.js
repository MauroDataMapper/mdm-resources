...
var MdmTreeItemResource = /** @class */ (function (_super) {
    ...
    // }
    MdmTreeItemResource.prototype.deletedModels = function (containerDomainType, modelDomainType, queryStringParams) {
    ...
    MdmTreeItemResource.prototype.modelSupersededModels = function (containerDomainType, modelDomainType, queryStringParams) {
        var url = this.apiEndpoint + "/admin/tree/" + containerDomainType + "/" + modelDomainType + "/modelSuperseded";
        return this.simpleGet(url, queryStringParams);
    };
    MdmTreeItemResource.prototype.documentationSupersededModels = function (containerDomainType, modelDomainType, queryStringParams) {
        var url = this.apiEndpoint + "/admin/tree/" + containerDomainType + "/" + modelDomainType + "/documentationSuperseded";
        return this.simpleGet(url, queryStringParams);
    };
    MdmTreeItemResource.prototype.search = function (containerDomainType, searchTerm, queryStringParams) {
        var url = this.apiEndpoint + "/tree/" + containerDomainType + "/search/" + searchTerm;
        return this.simpleGet(url, queryStringParams);
    };
    MdmTreeItemResource.prototype.list = function (containerDomainType, queryStringParams) {
        var url = this.apiEndpoint + "/tree/" + containerDomainType;
        return this.simpleGet(url, queryStringParams);
    };
    MdmTreeItemResource.prototype.get = function (containerDomainType, catalogueItemDomainType, catalogueItemId, queryStringParams) {

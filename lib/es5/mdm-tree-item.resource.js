...
var MdmTreeItemResource = /** @class */ (function (_super) {
    ...
    MdmTreeItemResource.prototype.getExpandedTree = function (containerDomainType, catalogueItemId, queryStringParams, restHandlerOptions) {
        var url = this.apiEndpoint + "/tree/" + containerDomainType + "/" + catalogueItemId;
        return this.simpleGet(url, queryStringParams, restHandlerOptions);
    };

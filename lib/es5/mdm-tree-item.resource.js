...
var MdmTreeItemResource = /** @class */ (function (_super) {
   ...
   */
     ...
     */
    MdmTreeItemResource.prototype.ancestors = function (containerDomainType, multiFacetAwareDomainType, id, query, options) {
        var url = this.apiEndpoint + "/tree/" + containerDomainType + "/" + multiFacetAwareDomainType + "/" + id + "/ancestors";
        return this.simpleGet(url, query, options);
    };

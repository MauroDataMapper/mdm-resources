...
var MdmAuthenticationResource = /** @class */ (function (_super) {
    ...
    MdmAuthenticationResource.prototype.login = function (data) {
        return this.securityResource.login(data);
    };
    MdmAuthenticationResource.prototype.logout = function () {
        return this.securityResource.logout();
    };
    MdmAuthenticationResource.prototype.isAuthenticated = function (sessionId) {

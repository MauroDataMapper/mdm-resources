...
var MdmAuthenticationResource = /** @class */ (function (_super) {
    ...
    MdmAuthenticationResource.prototype.login = function (data, options) {
        if (options === void 0) { options = {}; }
        return this.securityResource.login(data, options);
    };
    MdmAuthenticationResource.prototype.logout = function (data, options) {
        if (options === void 0) { options = {}; }
        return this.securityResource.logout(data, options);
    };
    MdmAuthenticationResource.prototype.isAuthenticated = function (sessionId, options) {
        if (options === void 0) { options = {}; }
        this.sesisonResource.isAuthenticated(sessionId, options);
    };

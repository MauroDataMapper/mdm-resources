...
var MdmCatalogueItemResource = /** @class */ (function (_super) {
     ...
     */
    MdmCatalogueItemResource.prototype.saveAnnotations = function (domainType, id, data, options) {
        var url = this.apiEndpoint + "/" + domainType + "/" + id + "/annotations";
     ...
     * `200 OK` - will return a {@link AnnotationDetailResponse} containing a {@link Annotation} object.
     */
    MdmCatalogueItemResource.prototype.saveAnnotationChildren = function (domainType, catalogueItemId, annotationId, data, options) {
        var url = this.apiEndpoint + "/" + domainType + "/" + catalogueItemId + "/annotations/" + annotationId + "/annotations";
        return this.simplePost(url, data, options);
    };
    /**
     ...
     */
    MdmCatalogueItemResource.prototype.listAnnotations = function (domainType, id, query, options) {
        var url = this.apiEndpoint + "/" + domainType + "/" + id + "/annotations";
     ...
     * @see {@link MdmCatalogueItemResource.getAnnotation}
     */
    MdmCatalogueItemResource.prototype.listAnnotationChildren = function (domainType, catalogueItemId, annotationId, query, options) {
        var url = this.apiEndpoint + "/" + domainType + "/" + catalogueItemId + "/annotations/" + annotationId + "/annotations";
        return this.simpleGet(url, query, options);
    };
    /**
     ...
     */
    MdmCatalogueItemResource.prototype.removeAnnotation = function (domainType, catalogueItemId, annotationId, query, options) {
        var url = this.apiEndpoint + "/" + domainType + "/" + catalogueItemId + "/annotations/" + annotationId;
     ...
     * On success, the response will be a `204 No Content` and the response body will be empty.
     */
    MdmCatalogueItemResource.prototype.removeAnnotationChild = function (domainType, catalogueItemId, annotationId, childId, query, options) {
        var url = this.apiEndpoint + "/" + domainType + "/" + catalogueItemId + "/annotations/" + annotationId + "/annotations/" + childId;
        return this.simpleDelete(url, query, options);
    };
    /**
     ...
     * `200 OK` - will return a {@link AnnotationDetailResponse} containing a {@link Annotation} object.
     */
    MdmCatalogueItemResource.prototype.getAnnotation = function (domainType, catalogueItemId, annotationId, query, options) {
        var url = this.apiEndpoint + "/" + domainType + "/" + catalogueItemId + "/annotations/" + annotationId;
        return this.simpleGet(url, query, options);
    };
    /**
     ...
     * `200 OK` - will return a {@link AnnotationDetailResponse} containing a {@link Annotation} object.
     */
    MdmCatalogueItemResource.prototype.getAnnotationChild = function (domainType, catalogueItemId, annotationId, childId, query, options) {
        var url = this.apiEndpoint + "/" + domainType + "/" + catalogueItemId + "/annotations/" + annotationId + "/annotations/" + childId;
        return this.simpleGet(url, query, options);
    };
    // Classifier

...
var MdmCatalogueItemResource = /** @class */ (function (_super) {
    ...
    // }
    //Annotation
    MdmCatalogueItemResource.prototype.saveAnnotations = function (catalogueItemDomainType, catalogueItemId, data, options) {
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/annotations";
        return this.simplePost(url, data, options);
    };
    MdmCatalogueItemResource.prototype.saveAnnotationChildren = function (catalogueItemDomainType, catalogueItemId, annotationId, data, options) {
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/annotations/" + annotationId + "/annotations";
        return this.simplePost(url, data, options);
    };
    MdmCatalogueItemResource.prototype.listAnnotations = function (catalogueItemDomainType, catalogueItemId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/annotations";
        return this.simpleGet(url, options);
    };
    MdmCatalogueItemResource.prototype.listAnnotationChildren = function (catalogueItemDomainType, catalogueItemId, annotationId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/annotations/" + annotationId + "/annotations";
        return this.simpleGet(url, options);
    };
    MdmCatalogueItemResource.prototype.removeAnnotation = function (catalogueItemDomainType, catalogueItemId, annotationId, options) {
        if (options === void 0) { options = {}; }
    ...
    MdmCatalogueItemResource.prototype.removeAnnotationChild = function (catalogueItemDomainType, catalogueItemId, annotationId, childId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/annotations/" + annotationId + "/annotations/" + childId;
        return this.simpleDelete(url, options);
    };
    MdmCatalogueItemResource.prototype.getAnnotation = function (catalogueItemDomainType, catalogueItemId, annotationId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/annotations/" + annotationId;
        return this.simpleGet(url, options);
    };
    MdmCatalogueItemResource.prototype.getAnnotationChild = function (catalogueItemDomainType, catalogueItemId, annotationId, childId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/annotations/" + annotationId + "/annotations/" + childId;
        return this.simpleGet(url, options);
    };
    // Classifier
    MdmCatalogueItemResource.prototype.saveClassifiers = function (catalogueItemDomainType, catalogueItemId, data, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/classifiers";
        return this.simplePost(url, data, options);
    };
    MdmCatalogueItemResource.prototype.listClassifiers = function (catalogueItemDomainType, catalogueItemId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/classifiers";
        return this.simpleGet(url, options);
    };
    MdmCatalogueItemResource.prototype.removeClassifier = function (catalogueItemDomainType, catalogueItemId, classifierId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/classifiers/" + classifierId;
        return this.simpleDelete(url, options);
    };
    MdmCatalogueItemResource.prototype.getClassifier = function (catalogueItemDomainType, catalogueItemId, classifierId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/classifiers/" + classifierId;
        return this.simpleGet(url, options);
    };
    // Metadata
    MdmCatalogueItemResource.prototype.saveMetadata = function (catalogueItemDomainType, catalogueItemId, data, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/metadata";
        return this.simplePost(url, data, options);
    };
    MdmCatalogueItemResource.prototype.listMetadata = function (catalogueItemDomainType, catalogueItemId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/metadata";
        return this.simpleGet(url, options);
    };
    MdmCatalogueItemResource.prototype.removeMetadata = function (catalogueItemDomainType, catalogueItemId, metadataId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/metadata/" + metadataId;
        return this.simpleDelete(url, options);
    };
    MdmCatalogueItemResource.prototype.updateMetadata = function (catalogueItemDomainType, catalogueItemId, metadataId, data, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/metadata/" + metadataId;
        return this.simplePut(url, data, options);
    };
    MdmCatalogueItemResource.prototype.getMetadata = function (catalogueItemDomainType, catalogueItemId, metadataId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/metadata/" + metadataId;
        return this.simpleGet(url, options);
    };
    // Reference Files
    MdmCatalogueItemResource.prototype.saveReferenceFiles = function (catalogueItemDomainType, catalogueItemId, data, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/referenceFiles";
        return this.simplePost(url, data, options);
    };
    MdmCatalogueItemResource.prototype.listReferenceFiles = function (catalogueItemDomainType, catalogueItemId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/referenceFiles";
        return this.simpleGet(url, options);
    };
    MdmCatalogueItemResource.prototype.removeReferenceFile = function (catalogueItemDomainType, catalogueItemId, referenceFileId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/referenceFiles/" + referenceFileId;
        return this.simpleDelete(url, options);
    };
    MdmCatalogueItemResource.prototype.updateReferenceFile = function (catalogueItemDomainType, catalogueItemId, referenceFileId, data, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/referenceFiles/" + referenceFileId;
        return this.simplePut(url, data, options);
    };
    MdmCatalogueItemResource.prototype.getReferenceFile = function (catalogueItemDomainType, catalogueItemId, referenceFileId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/referenceFiles/" + referenceFileId;
        return this.simpleGet(url, options);
    };
    // Semantic Links
    MdmCatalogueItemResource.prototype.saveSemanticLinks = function (catalogueItemDomainType, catalogueItemId, data, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/semanticLinks";
        return this.simplePost(url, data, options);
    };
    MdmCatalogueItemResource.prototype.listSemanticLinks = function (catalogueItemDomainType, catalogueItemId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/semanticLinks";
        return this.simpleGet(url, options);
    };
    MdmCatalogueItemResource.prototype.removeSemanticLink = function (catalogueItemDomainType, catalogueItemId, semanticLinkId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/semanticLinks/" + semanticLinkId;
        return this.simpleDelete(url, options);
    };
    MdmCatalogueItemResource.prototype.updateSemanticLink = function (catalogueItemDomainType, catalogueItemId, semanticLinkId, data, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/semanticLinks/" + semanticLinkId;
        return this.simplePut(url, data, options);
    };
    MdmCatalogueItemResource.prototype.getSemanticLink = function (catalogueItemDomainType, catalogueItemId, semanticLinkId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/semanticLinks/" + semanticLinkId;
        return this.simpleGet(url, options);
    };

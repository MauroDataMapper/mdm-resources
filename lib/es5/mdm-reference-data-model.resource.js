...
var MdmReferenceDataModelResource = /** @class */ (function (_super) {
     ...
     */
    MdmReferenceDataModelResource.prototype.modelVersionTree = function (id, query, options) {
        var url = this.apiEndpoint + "/referenceDataModels/" + id + "/modelVersionTree";
        return this.simpleGet(url, query, options);
    };
    /**
     ...
     */
    MdmReferenceDataModelResource.prototype.simpleModelVersionTree = function (id, query, options) {
        var url = this.apiEndpoint + "/referenceDataModels/" + id + "/simpleModelVersionTree";
        return this.simpleGet(url, query, options);
    };

...
var MdmMetadataResource = /** @class */ (function (_super) {
    ...
    MdmMetadataResource.prototype.namespaces = function (metadataId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/metadata/namespaces" + (metadataId ? "/" + metadataId : '');
        return this.simpleGet(url, options);
    };
    MdmMetadataResource.prototype.save = function (catalogueItemDomainType, catalogueItemId, data, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/metadata";
        return this.simplePost(url, data, options);
    };
    MdmMetadataResource.prototype.list = function (catalogueItemDomainType, catalogueItemId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/metadata";
        return this.simpleGet(url, options);
    };
    MdmMetadataResource.prototype.remove = function (catalogueItemDomainType, catalogueItemId, metadataId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/metadata/" + metadataId;
        return this.simpleDelete(url, options);
    };
    MdmMetadataResource.prototype.update = function (catalogueItemDomainType, catalogueItemId, metadataId, data, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/metadata/" + metadataId;
        return this.simplePut(url, data, options);
    };
    MdmMetadataResource.prototype.get = function (catalogueItemDomainType, catalogueItemId, metadataId, options) {
        if (options === void 0) { options = {}; }
        var url = this.apiEndpoint + "/" + catalogueItemDomainType + "/" + catalogueItemId + "/metadata/" + metadataId;
        return this.simpleGet(url, options);
    };

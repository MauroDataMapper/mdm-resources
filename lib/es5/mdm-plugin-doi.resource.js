...
var MdmPluginDoiResource = /** @class */ (function (_super) {
    ...
    MdmPluginDoiResource.prototype.get = function (domainType, id, query, options) {
        var url = this.apiEndpoint + "/" + getMultiFacetAwareDomainType(domainType) + "/" + id + "/doi";
    ...
    MdmPluginDoiResource.prototype.save = function (domainType, id, query, options) {
        ...
        var url = this.apiEndpoint + "/" + getMultiFacetAwareDomainType(domainType) + "/" + id + "/doi" + queryString;
     ...
     */
    MdmPluginDoiResource.prototype.resolve = function (identifier, query, options) {
        var url = this.apiEndpoint + "/doi/" + identifier;
        return this.simpleGet(url, query, options);
    };

...
var MdmVersionedFolderResource = /** @class */ (function (_super) {
     ...
     */
    MdmVersionedFolderResource.prototype.modelVersionTree = function (id, query, options) {
        var url = this.apiEndpoint + "/versionedFolders/" + id + "/modelVersionTree";
        return this.simpleGet(url, query, options);
    };
    /**
     ...
     */
    MdmVersionedFolderResource.prototype.simpleModelVersionTree = function (id, query, options) {
        var url = this.apiEndpoint + "/versionedFolders/" + id + "/simpleModelVersionTree";
        return this.simpleGet(url, query, options);
    };
